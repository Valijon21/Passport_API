...
class StructuredFieldsSerializer(serializers.Serializer):
    ...
    personal_number = serializers.CharField(allow_null=True, required=False)
    ...
    date_of_birth = serializers.CharField(allow_null=True, required=False)
    expiry_date = serializers.CharField(allow_null=True)
    date_of_expiry = serializers.CharField(allow_null=True, required=False)
    issue_date = serializers.CharField(allow_null=True)
    date_of_issue = serializers.CharField(allow_null=True, required=False)
...
class OCRResponseSerializer(serializers.Serializer):
    ...
    citizen_profile = serializers.DictField(allow_null=True, required=False)
